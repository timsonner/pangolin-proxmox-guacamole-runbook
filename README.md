...
openssl req -x509 -nodes -newkey rsa:2048 -days 3650   -keyout /opt/guacamole/certs/guac.key   -out /opt/guacamole/certs/guac.crt   -subj "/CN=guacamole.local"
```
...
# Load schema
cat /opt/guacamole/postgresql/schema/001-create-schema.sql   /opt/guacamole/postgresql/schema/002-create-admin-user.sql |   PGPASSWORD="$POSTGRES_PASSWORD" psql -h 127.0.0.1 -U guacamole -d guacamole
```
